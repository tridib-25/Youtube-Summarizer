...
# scores = files_rouge.get_scores("./transcript.txt", "./summary.txt", avg=True)
# print(scores)


# Initialize the ROUGE object
# generated_summary = open("./summary.txt",encoding="utf8").read()
# reference_summary = open("./transcript.txt",encoding="utf8").read()
# print(type(generated_summary))
# reksjfj="jvj"
# print(type(reksjfj))
...
scores = evaluator.get_scores(hypothesis_1, references_2)
